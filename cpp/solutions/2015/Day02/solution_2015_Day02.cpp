...
TEST_CASE("2015_Day02", "[2015]")
{
    SECTION("Example")
    {
        std::string entry =
            AOCCommon::ParseFile(AOCCommon::GetRootPath() / "solutions" / "2015" / "Day02" / "example.txt");
    ...
    {
        std::string entry =
            AOCCommon::ParseFile(AOCCommon::GetRootPath() / "solutions" / "2015" / "Day02" / "entry.txt");
